...
// Define a Post model that extends the Sequelize Model class
class Post extends Model {}

// Initialize the Post model with the table schema and options
Post.init (
    {
        ...
        // Define the 'title' column as a non-null string
        title: {
    ...
    },
    {
        ...
        timestamps: false,
        // Set the table name to 'post' (instead of the default 'posts')
        freezeTableName: true,
        // Use underscores for column names (i.e. 'date_created', instead of 'dateCreated')
        underscored: true,
        // Set the model name to 'post' (instead of the default 'Post')
        modelName: 'post'
    }
);
